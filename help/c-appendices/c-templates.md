...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 如果您要傳回XML，可使用此標籤來建立XML聲明。 將此標籤設為簡報範本中的第一行。 使用此標籤時，content-type會自動設為text/xml，除非您在第一行中以<span class="codeph"> &lt;guided-content-type-header&gt; </span>覆寫它。 如果您未指定字元集，則預設為UTF-8。 此標籤會在XML檔案中產生下列輸出： </p> <p> <span class="codeph"> &lt;?xml version="1.0" encoding="charset-name" standalone="yes" ?&gt; </span> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>若要建立指定結果的連結，請使用<span class="codeph"> guided-result-link </span>標籤。 通過定義<span class="codeph"> gsname </span>屬性，您可以使用索引中的欄位，而不是引用"search-url"的標準"loc"標籤。 任何其他屬性（例如類別和目標）也可以傳遞，這些屬性會輸出到產生的錨點標籤中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
   <td colname="col1"> <p> 
     <!--In search-eng 1/31/13--> <span class="codeph"> &lt;guided-result-img gsname="fieldname"&gt; </span> </p> </td> 
   <td colname="col2"> <p><span class="codeph"> &lt;guided-result-img&gt; </span>標籤有助於建立影像標籤，而非將變數內嵌在原始<span class="codeph"> img </span>標籤中。 </p> <p>在<span class="codeph"> gsname </span>屬性中指定用於影像路徑的欄位。 結果會產生<span class="codeph"> img </span>標籤，內含您所定義、傳遞的任何標準HTML屬性。 所以，下面的例子是： </p> <p> <code class="syntax html"> &lt;guided-result-img&nbsp;gsname="thumbnail" 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 結果中顯示的任何資訊會顯示為<span class="codeph"> &lt;guided-result-field&gt; </span>標籤(使用自動產生標籤（例如<span class="codeph"> &lt;guided-result-img&gt; </span>標籤）。 </p> <p>在<span class="codeph"> gsname </span>中指定「搜索索引」欄位的名稱。 傳遞的確切字串會在範本中輸出。 </p> <p>如果希望此欄位與傳輸模板中指定的欄位進行不同的逸出，則可以指定逸出選項。 </p> <p>此編碼會套用在傳輸範本中指定的任何編碼上。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在列中顯示結果時，此標籤用於標識當前結果是否標籤列的結尾。 </p> <p>當布爾條件為true時，會將HTML添加到結果的末尾，以完成行並啟動新行。 當是最後一行時，不會啟動新行。 </p> <p>請參閱<span class="codeph"> &lt;guided-if-not-last&gt; </span>以進一步瞭解該標籤。 </p> <p> <code class="syntax html"> &lt;guided-if-result-wrap&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;guided-if-not-last&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-not-last&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果後端搜尋請求傳回結果，則傳回1；如果未傳回，則傳回0。 如果未指定<span class="codeph"> gsname </span>，則標籤會假定主搜索。 此標籤對於將邏輯傳遞至JavaScript常式很有用。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>8 </p> </td> 
   <td colname="col1"> <p> 
     <!--In search-eng version 1/31/13--> <span class="codeph"> &lt;guided-results-total&gt; </span> </p> </td> 
   <td colname="col2"> <p>傳回指定結果集中的結果總數。 當未提供<span class="codeph"> gsname </span>時，假設預設搜索。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
   <td colname="col1"> <p> 
     <!--In search-eng version 1/31/13--> <span class="codeph"> &lt;guided-results-lower&gt; </span> </p> </td> 
   <td colname="col2"> <p>返回指定結果集的頁面上較低結果的結果編號。 當未提供<span class="codeph"> gsname </span>時，假設預設搜索。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>10 </p> </td> 
   <td colname="col1"> <p> 
     <!--In search-eng version 1/31/13--> <span class="codeph"> &lt;guided-results-upper&gt; </span> </p> </td> 
   <td colname="col2"> <p>返回指定結果集頁面上上方結果的結果編號。 當未提供<span class="codeph"> gsname </span>時，假設預設搜索。 </p> </td> 
  </tr> 
  <tr> 
...
<td colname="col2"> <p>在找到結果時顯示內容。 或者，找不到結果時，不顯示結果HTML。 </p> <p> <code class="syntax html"> &lt;guided-if-results-found&nbsp;gsname="products"&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="codeph"> &lt;guided-result-title&gt; </span>標籤提供了使用<span class="codeph"> &lt;title&gt; </span>傳輸標籤指定的標題傳輸模板欄位的值。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>13 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-result-description /&gt; </span> </p> </td> 
   <td colname="col2"> <p><span class="codeph"> &lt;guided-result-description&gt; </span>標籤提供了使用<span class="codeph"> &lt;description&gt; </span>傳輸標籤指定的description傳輸模板欄位的值。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>14 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;guided-result-loc /&gt; </span> </p> </td> 
   <td colname="col2"> <p>&lt;<span class="codeph"> guided-result-loc&gt; </span>標籤提供了loc transport模板欄位的值，該欄位用<span class="codeph"> &lt;loc&gt; </span>傳輸標籤指定。 </p> </td> 
  </tr> 
  <tr> 
...
<td colname="col2"> <p>如果特定欄位中有要顯示的內容，則為true。 如果沒有內容，則條件為false。 使用標籤來決定是否顯示周圍的HTML（如果沒有值，或是顯示不同的影像），依此類推。 </p> <p> <code class="syntax html"> &lt;guided-if-result-field&nbsp;gsname="thumbnail"&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>此標籤提供在傳輸模板中定義的具有<span class="codeph"> &lt;attribute_table&gt; </span>傳輸標籤的循環屬性表。 有<span class="codeph"> &lt;guided-result-attribute-table-field&gt; </span>標籤可顯示屬性表欄位值。 此外，還可在回圈內使用plain <span class="codeph"> guided-result-field </span>標籤來顯示其他結果欄位。 </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>顯示在傳輸模板中定義的屬性表欄位。 </p> <p> 
    ...
    &amp;lt; guided-result-attribute-table&amp;nbsp;gsname=&quot;下載&quot;&amp;gt;
    &amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;a&amp;nbsp;a&amp;nbsp;href=&quot;&amp;lt;guided-rest-at-at-at-attribute-table-nbsp&quot;download_link&quot;&amp;nbsp;/&amp;gt;&quot;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;lt;guid-result-attribute-table-field&amp;nbsp;gsname=&quot;download_title&quot;&amp;nbsp;/&amp;gt;
    &amp;nbsp;
    &amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbs;&amp;nbs;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbs;&amp;nbsp;&amp;nbsp;&amp;nbs;&amp;nbs;&amp;n;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbs;&amp;nbsp;&amp;nbsp;&amp;n;&amp;nbs;&amp;nbsp;&amp;n&amp;nbsp;&amp;nbsp;/a&amp;gt;&amp;nbsp;(&amp;lt; guided-result-field&amp;nbsp; gsname=&quot;title&quot;/&amp;gt)
    &amp;nbsp;&amp;lt;/li&amp;gt;
  ...
  <tr> 
   ...
   <td colname="col2"> <p>將追蹤資料中找到的追蹤資訊，輸出給定搜尋的傳輸範本所輸出JSON資料的一般區段。 </p> <p>如果未提供搜索名稱，則假定<span class="codeph">預設</span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>19 </p> </td> 
   <td colname="col1"> <p> 
     <!--NEW for S&P 8.17.0 release on October 30, 2014)--> <span class="codeph"> &lt;guided-result-trace /&gt; </span> </p> </td> 
   <td colname="col2"> <p>輸出目前搜尋結果之傳輸範本所輸出之JSON資料的結果&gt;追蹤資訊中找到的JSON內容。 </p> <p>此標籤僅在<span class="codeph"> &lt;guided-results&gt;&lt;/guided-results&gt; </span>循環中有效。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
請參閱[關於動態面](../c-about-design-menu/c-about-dynamic-facets.md#concept_E65A70C9C2E04804BF24FBE1B3CAD899)。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> 
    <!--NEW 2/2/2014--> <p>特定搜尋之任何動態Facet的循環內容。 </p> <p>編輯<span class="codeph"> &lt;guided-facet&gt; </span>簡報範本標籤，讓<span class="codeph"> &lt;guided-dynamic-facets&gt; </span>循環內容自動提供gsname屬性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 定義表示範本的區段，該區段用作Facet邊欄中每個Facet的重複圖樣。 </p> <p> 屬於Facet邊欄的每個Facet都會使用此區段來評估其輸出。 </p> <p>以下是Facet邊欄的範例： </p> <p> <code class="syntax html"> &lt;guided-facet-rail&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;... 
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-facet&gt; 
      &nbsp;&nbsp;&lt;/guided-facet-rail&gt; </code> </p> <p>請注意，當<span class="codeph"> &lt;guided-facet-rail&gt; </span>標籤內部時，下列標籤不需要<span class="codeph"> gsname </span>屬性，因為值會在搜尋時動態決定並正確取代： </p> 
    ...
    </ul> <p><span class="wintitle"> Facet Rail </span>頁面上的排序標準會決定Facet的位置。 您可以從「排序刻面方法」下拉式清單中選擇排序順序。 </p> <p> 
     <!--NEW 02/27/2014-->此標籤可選擇接受 <span class="codeph"> _dynamic_facets的gsname屬性值 </span>，此值可為此搜尋的任何動態Facet提供循環內容。此預先定義的Facet邊欄也會在Business Rules使用者介面中公開，以便在Facet邊欄「_dynamic_facets」中執行<span class="codeph">推送Facet X，以定位Y </span>」。 </p> <p>請參閱<a href="../c-about-design-menu/c-about-facet-rails.md#concept_1FDC8BCDFFC84A0889DA670F63D5F6DB" format="dita" scope="local">關於 Facet 軌</a>。 </p> <p>另請參閱<a href="../c-about-design-menu/c-about-dynamic-facets.md#concept_E65A70C9C2E04804BF24FBE1B3CAD899" format="dita" scope="local">關於動態面</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> 
   ...
   <td colname="col2"> <p>使用<span class="codeph"> guided-facet </span>標籤來定義所有facet標籤與特定facet相關的區域。 此標籤也是布林標籤，如果Facet中沒有值，則會隱藏所有內容。 在這種情況下，沒有輸出刻面值的點)。 </p> <p>高度和寬度屬性是可選的，尺寸以像素(px)指定。 「視覺化規則產生器」(VRB)會使用這兩個屬性，並在Facet隱藏時，將虛線方塊顯示為互動預留位置。 </p> <p> 當顯示名稱位於Facet中且Facet已隱藏時，名稱也會隱藏。 但是，如果名稱不在Facet外，則只有在<span class="codeph">區域</span>標籤或<span class="codeph"> guided-if-facet-visible </span>標籤被包住時，您才能隱藏名稱。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   <td colname="col1"> <p> 
   ...
   <td colname="col2"> <p>當Facet值數量超過設定中定義的長度臨界值時，此條件標籤為true。 當清單過長時，可使用它將Facet顯示為不同的UI元素（例如截斷的清單或捲動方塊）。 </p> <p> <code class="syntax xml"> &lt;guided-facet&nbsp;name="category"&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-facet-values&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-facet-long&gt; 
      &lt;/guided-facet&gt; </code> </p> <p>您也可以在名為<span class="codeph">的guided-facet </span>區塊的上下文外使用此條件，方法是直接使用<span class="codeph"> gsname </span>屬性來參照特定facet。 </p> <p> <code class="syntax html"> &lt;guided-if-facet-long&nbsp;gsname="category"&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>當Facet至少被點按一次且目前已選取Facet值時，此條件標籤為true。 它會用來顯示或隱藏HTML或gs標籤，視點按Facet而定。 </p> <p> <code class="syntax html"> &lt;guided-facet&nbsp;name="category"&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-facet-values&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-facet-selected&gt; 
      &lt;/guided-facet&gt; </code> </p> <p>您也可以在名為<span class="codeph">的guided-facet </span>區塊的上下文外使用此條件，方法是直接使用<span class="codeph"> gsname </span>屬性來參照特定facet。 </p> <p> <code> &lt;guided-if-facet-selected&nbsp;gsname="category"&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>當只有一個Facet值時，此條件標籤為true。 當Facet無法調整結果時，使用標籤來變更其顯示。 </p> <p> <code class="syntax html"> &lt;guided-facet&nbsp;name="category"&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-facet-values&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-facet-single&gt; 
      &lt;/guided-facet&gt; </code> </p> <p>您也可以在名為<span class="codeph">的guided-facet </span>區塊的上下文外使用此條件，方法是直接使用<span class="codeph"> gsname </span>屬性來參照特定facet。 </p> <p> <code class="syntax html"> &lt;guided-if-facet-single&nbsp;gsname="category"&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>當Facet為多選時，此條件標籤為true。 使用標籤來變更<span class="codeph"> &lt;guided-facet-rail&gt; </span>或<span class="codeph"> &lt;guided-dynamic-facets&gt; </span>標籤內的Facet顯示。 </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>這是Facet值循環迭代器標籤。 您可在名為<span class="codeph">的guided-facet </span>區塊的內容中定義它，在此情況下，您可以省略<span class="codeph"> <span class="varname"> gsname </span> </span>。 或者，您可以在任何<span class="codeph">引導-facet </span>區塊外定義它，但它需要<span class="codeph"> <span class="varname"> gsname </span> </span>屬性來識別顯示哪組facet值。 </p> <p>您也可以使用此標籤，在名為<span class="codeph"> guided-facet </span>區塊的上下文外顯示facet值。 您可使用<span class="codeph"> <span class="varname"> gsname </span> </span>屬性直接參考特定Facet。 </p> <p> <code class="syntax html"> &lt;script&gt; 
...
<td colname="col2"> <p>變更刻面值是重影值時的顯示。 當Facet值是重影值時，它通常以斜體文字顯示，以指出該值遺失或是「重影」。 </p> <p>以下程式碼摘錄是Facet區塊的範例： </p> <p> <code class="syntax html"> &lt;guided-facet-values&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>當Facet值數量超過設定中定義的長度臨界值時，此條件標籤為true。 當清單過長時，使用它可將Facet顯示為不同的使用者介面元素（例如截斷的清單或捲動方塊）。 </p> <p> <code class="syntax html"> &lt;guided-facet&nbsp;gsname="category"&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-facet-long&gt; 
      &nbsp;&lt;/guided-facet&gt; </code> </p> <p>您也可以在名為<span class="codeph">的guided-facet </span>區塊的上下文外使用此條件，方法是直接使用<span class="codeph"> <span class="varname"> gsname </span> </span>屬性來參照特定Facet。 </p> <p> <code class="syntax html"> &lt;guided-if-facet-long&nbsp;gsname="category"&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The&nbsp;category&nbsp;facet&nbsp;is&nbsp;very&nbsp;long! 
      &lt;/guided-if-facet-long&gt; </code> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>當Facet至少被點按一次且目前已選取Facet值時，此條件標籤為true。 它可用來顯示或隱藏HTML或gs標籤，視點按Facet而定。 </p> <p> <code class="syntax html"> &lt;guided-facet&nbsp;gsname="category"&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-facet-values&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-facet-selected&gt; 
      &lt;/guided-facet&gt; </code> </p> <p>您也可以在名為<span class="codeph">的guided-facet </span>區塊的上下文外使用此條件，方法是直接使用<span class="codeph"> gsname </span>屬性來參照特定facet。 </p> <p> <code class="syntax html"> &lt;guided-if-facet-selected&nbsp;gsname="category"&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The&nbsp;category&nbsp;facet&nbsp;is&nbsp;selected! 
      &lt;/guided-if-facet-selected&gt; </code> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>當只有一個Facet值時，此條件標籤為true。 當Facet無法調整結果時，它可用來變更Facet的顯示。 </p> <p> <code class="syntax html"> &lt;guided-facet&nbsp;gsname="category"&gt; 
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-facet-values&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/guided-if-facet-single&gt; 
      &lt;/guided-facet&gt; </code> </p> <p>您也可以在名為<span class="codeph">的guided-facet </span>區塊的上下文外使用此條件，方法是直接使用<span class="codeph"> <span class="varname"> gsname </span> </span>屬性來參照特定Facet。 </p> <p> <code class="syntax html"> &lt;guided-if-facet-single&nbsp;gsname="category"&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;There&nbsp;is&nbsp;only&nbsp;one&nbsp;value&nbsp;in&nbsp;the&nbsp;category&nbsp;facet! 
      &lt;/guided-if-facet-single&gt; </code> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>當<span class="codeph"> &lt;guided-facet-values&gt; </span>逐步遍歷每個facet值時，此標籤會重複嵌套facet的所有子值。 在此標籤內，使用一般的Facet標籤來建立連結、建立還原連結及顯示Facet值。 此標籤必須位於<span class="codeph"> &lt;guided-facet-values&gt; </span>內，因為它會巢狀循環。 </p> <p>使用此標籤的範例如下： </p> <p> <code class="syntax html"> &lt;guided-facet-values&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>測試目前Facet值是否具有子值。 建議在使用<span class="codeph"> &lt;guided-facet-value-children&gt; </span>標籤前使用。 "else"子句是可選的。 </p> </td> 
  </tr> 
  <tr> 
...
<td colname="col2"> <p>判斷facet-values回圈中的目前facet值是否高於長度臨界值。 它通常用於只顯示長刻面上低於臨界值的值（除非使用者先前選取了顯示在刻面下方的「檢視更多」連結）。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col1"> <p> 
    ...
    &amp;lt;guided-else[-not]-facet-values-equals-length-threshold&amp;gt;
    
    &amp;lt;/guided-if[-not]-facet-values-equals-length-threshold&amp;gt;   &lt;/p>  &lt;/td>
<td colname="col2"> <p>判斷facet-values回圈中的目前facet值是否等於長度臨界值。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>顯示指定選取之Facet值的還原連結。 使用它可在選取的Facet值旁顯示還原連結。 由於此還原連結只會解除該特定選取的值，因此與<span class="codeph"> &lt;guided-facet-undo-link&gt; </span>不同，&lt;a1/&gt;會取消選取所有選取的值。 </p> <p> <p>注意： 如果Facet沒有多選行為，則兩個還原連結有相同的行為。 也就是說，Facet只能有一個選取的值。 </p> </p> <p>如果Facet目前未選取，則連結是目前路徑。 僅在<span class="codeph"> guided-facet-values </span>循環中使用此標籤。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>建立您自己的Facet還原連結。 </p> <p> 與<span class="codeph"> &lt;guided-facet-undo-link&gt; </span>標籤類似，但它提供原始路徑以建立您自己的還原連結。 </p> </td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>階層連結的循環標籤。 對於當前狀態的每個查詢編號，會迭代在開始和結束標籤之間的任何內容。 </p> <p>如果省略<span class="codeph"> <span class="varname"> gsname </span> </span>，則使用名為"default"的導覽路徑標示。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> 
     <!--Matched search-eng version, 2/1/2013--> <span class="codeph"> &lt;guided-breadcrumb-link&gt;&lt;/guided-breadcrumb-link&gt; </span> </p> </td> 
   <td colname="col2"> <p>在階層連結中建立連結。 預設行為是「goto」行為。 如果連結的運作方式不同，請使用<span class="codeph"> <span class="varname"> gsname </span> </span>選用屬性來指定"remove"或"drop"。 標籤中包含的任何屬性都會傳遞至產生的錨點標籤。 </p> <p> <code class="syntax html"> &lt;guided-breadcrumb&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>標籤標籤會輸出階層連結值的標籤，其中詳述選取要產生該階層連結項目的階層連結值。 它僅用於<span class="codeph">引導式導覽路徑標示</span>區塊的內容。 </p> <p> <code class="syntax html"> &lt;guided-breadcrumb&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;guided-breadcrumb-link&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果目前的階層連結值有標籤，則此條件標籤會用來有條件地顯示內容。 它僅用於在標籤實際存在時顯示標籤和關聯內容。 它僅用於<span class="codeph">引導式導覽路徑標示</span>區塊的內容。 </p> <p> <code class="syntax html"> &lt;guided-breadcrumb&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;guided-breadcrumb-link&gt; 
...
## 菜單{#section_1D489ADF041F4351A66E5D5742125CA8}
...
<td colname="col2"> <p>測試頁面導覽是否包含第一頁、上一頁、下一頁等。 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>使用<span class="codeph">引導編頁</span>標籤來定義一個區域，其中所有編頁標籤都與特定編頁設定相關，以備您定義的「頁面導覽設定」較少時使用。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>13 </p> </td> 
   <td colname="col1"> <p> 
...
請參閱[設定最近搜尋](../c-about-design-menu/t-configuring-recent-searches.md#task_E9E8ACA04C90484F8AFD5262167B2562)。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回<span class="codeph"> &lt;guided-recent-searches-clear-link&gt; </span>所使用的路徑，以便您建立自己的連結。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   <td colname="col1"> <p> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回建議的路徑字串。 您可使用它建立自己的錨點標籤。 通常會改用<span class="codeph"> guided-sembuction-link </span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>用於演示模板的搜索表單（在<span class="codeph"> &lt;form&gt; </span>和<span class="codeph"> &lt;/form&gt; </span>標籤之間），而不是硬編碼表單中的自動完成標籤。 標籤會以自動完成作業所需的適當HTML取代。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
...
## 商店{#section_A33E25DB5E67404A823BD9618665B773}
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>檢測用戶是否在儲存中<span class="codeph"> gsname </span>參數指定。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>您可以包覆區域標籤中的任何內容，以建立區域。 這可讓您使用業務規則來視需要顯示區域。 預設情況下，始終顯示區域。 您可以使用可選的搜尋和刻面參數來指出與區域關聯的搜尋或刻面。 這類功能可讓軟體在隱藏區域時略過搜尋或刻面，以改善搜尋時的效能。 高度和寬度屬性是可選的，用來設定移除區域時，預留位置顯示器在視覺化規則產生器中的顯示方式。 </p> <p> 使用<span class="codeph"> guided-if-facet[-not]-visible </span>標籤，而不是盡可能使用區域。 它可簡化簡報範本。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>提供您目前使用的路徑。 通常，它用於建立新增參數至現有搜尋的連結。 依預設，路徑為URL逸出。 您可以指定要通過轉義參數使用的轉義模式。 </p> <p>範例:   </p> <p> <code class="syntax html"> &lt;a&nbsp;href="&lt;guided-current-path&nbsp;/&gt;&amp;lang=fr"&gt; 
      French&nbsp;Version </code> </p> <p>在此範例中，搜尋處理規則使用lang來選取法文版本。 </p> <p>目前路徑一律至少有一個查詢參數。 如果沒有其他查詢參數，則將其設定為<span class="codeph"> q=* </span>，以便更輕鬆地添加更多參數。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> 基本路徑  </span> </p> </td> 
   <td colname="col2"> <p> 如果要使用基本路徑建立連結，請在<span class="codeph"> href </span>開頭使用<span class="codeph"> / </span>並添加參數。 </p> <p> <code class="syntax html"> &lt;a&nbsp;href="/"&gt;All&nbsp;Products&lt;/a&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>可讓您擷取URL上查詢參數的現有值。 如果您的參數不存在，此標籤會傳回空字串。 如果您未指定逸出選項，傳回的字串會自動HTML逸出，您可以指定HTML或URL逸出。 </p> <p>範例:   </p> <p> 
    ...
    &amp;nt;guided-query-param&amp;nbsp;gsname=&quot;lang&quot;&amp;nbsp;/&amp;gt;
    gibsp&amp;nbsp；您&amp;nbsp;n
  ...
  <tr> 
   ...
   <td colname="col2"> <p>引導式搜尋的概念是查詢編號，用於階層連結控制項。 <span class="codeph"> guided-query-param-name可讓您將參 </span> 數定義為簡報範本中連結的一部分，其中「guided Search」會為您找出正確的查詢編號。<span class="codeph"> gsname </span>中有"x",「引導式搜尋」會以正確的數字取代。 偏移值可以是0 - 15，其中0表示使用了下一個可用的查詢編號。 1表示您要新增1到它，依此類推。 </p> <p>結合<span class="codeph"> guided-current-path </span>，您可以建立自己的迷你Facet連結，或允許額外的下鑽層級。 </p> <p>範例:   </p> <p> <code class="syntax html"> &lt;a&nbsp;href="&lt;guided-current-path 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 可讓您包含其他範本檔案。 此功能表示您可以使用子範本做為模組來建立多個範本。 </p> <p>在下例中，包含<span class="filepath">導覽路徑標示</span>和<span class="filepath"> Facet </span>檔案： </p> <p> <code class="syntax html"> &lt;guided-include&nbsp;gsfile='breadcrumbs.tmpl'&nbsp;/&gt; 
      &lt;guided-include&nbsp;gsfile='facets.tmpl'&nbsp;/&gt; </code> </p> <p>不支援動態包含。 換言之，<span class="codeph"> gsfile </span>不能是變數。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
   <td colname="col1"> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>可讓您擷取處理規則所定義之自訂變數的現有值。 如果您未指定逸出選項，則傳回的字串會自動HTML逸出，您可以指定<span class="codeph"> html </span>、<span class="codeph"> url </span>、<span class="codeph"> js </span>或<span class="codeph"> 0 </span>。 如果您使用處理規則將傳入的CGI參數複製到自訂變數，然後在範本中顯示或使用該變數，並將逸出設定為無或js，則可在搜尋中建立XSS弱點。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>18 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>可讓您顯示傳輸範本中定義的一般欄位內容。 如果未指定轉義選項，則返回的字串將按照在該欄位的傳輸模板中指定的格式進行編碼。 指定逸出選項會套用在您要編碼欄位的任何格式上，就像在傳輸範本中一樣。 您可以指定<span class="codeph"> html </span>、<span class="codeph"> url </span>、<span class="codeph"> js </span>、<span class="codeph"> json </span>或<span class="codeph"> 0 </span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>20 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>可讓您擷取Cookie的值（假設Cookie可用）。 如果您未指定逸出選項，則傳回的字串會自動HTML逸出，您可以指定<span class="codeph"> html </span>、<span class="codeph"> url </span>、<span class="codeph"> js </span>、<span class="codeph"> json </span>或<span class="codeph"> 0 </span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>22 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>可讓您偵測是否有參考<span class="keyword"> Adobe Target </span>促銷活動的業務規則。 它通常用作與<span class="keyword"> Adobe Target </span>整合的一部分，以防止在不需要時點擊<span class="keyword"> Target </span>伺服器。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>27 </p> </td> 
...
## 傳輸模板標籤{#reference_227D199F5A7248049BE1D405C0584751}
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>標籤圍繞根據結果集提供摘要資料的搜索模板標籤。 通常，這些標籤包含搜尋標籤，用於搜尋總結果數、較低結果和最高結果。 您可以使用<span class="codeph"> general-field </span>標籤定義任意數量的附加全局欄位，如下例所示： </p> <p> <code class="syntax html"> &lt;general&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p><span class="codeph">分隔符</span>屬性可讓您變更在輸出清單的search-display-field資料時使用的分隔符。 預設值為逗號。 </p> <p>一般而言，您使用的分隔字元應該是無法立即顯示在欄位內容中的分隔字元。 </p> </td> 
  </tr> 
  <tr> 
...
## 結果循環字串標籤{#section_80D68334E8D04A33937A6E58ABAAA320}

下列標籤會傳回字串。

請參閱[關於結果循環標籤](../c-appendices/c-templates.md#section_D4DC7B4560144663972E8DBC3369C629)。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 返回當前結果的說明。 如果元描述標籤存在且內容屬性不為空，則會顯示該文本。 否則，將顯示頁面的正文文本的開頭。 選用的length屬性可用來限制顯示的字串長度，預設值為80個字元。 </p> <p>可選的<span class="codeph">編碼</span>屬性控制輸出是否為HTML編碼、JavaScript編碼、Perl編碼、URL編碼或未編碼，以便在結果頁上輸出。 <span class="codeph">編碼</span>的預設值為<span class="codeph"> html </span>。 通常，您不需要指定編碼屬性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   ...
   <td colname="col2"> <p>傳回目前結果的分數，即數字0 - 100。 如果您已在「<span class="uicontrol">選項</span> &gt; <span class="uicontrol">中繼資料</span> &gt; <span class="uicontrol">定義</span>」下定義了排名欄位，則可將排名屬性設為動態(<span class="codeph"> &lt;search-score rank="dynamic"&gt; </span>)，以顯示動態頁面排名。 您可將排名屬性設為靜態(<span class="codeph"> &lt;search-score rank="static"&gt; </span>)，以顯示靜態頁面排名。 您可以使用可選的precision屬性來指定要顯示的小數位數。 預設值為0，顯示整數分數)。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回目前結果的URL。 </p> <p>使用可選<span class="codeph"> length </span>屬性來限制顯示的字串長度，預設值為不限個字元。 </p> <p><span class="codeph"> encoding </span>屬性是可選的，它可以使用HTML編碼、Javascript編碼、Perl編碼或無來編碼輸出字元。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-url-path-query length="XX"&gt; </span> </p> </td> 
   <td colname="col2"> <p>傳回包含目前結果URL問號的路徑和查詢部分。 </p> <p>使用可選<span class="codeph"> length </span>屬性來限制顯示的字串長度，預設值為不限個字元。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>10 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-context length="XX" encoding="html/javascript/json/perl/url/none"&gt; </span> </p> </td> 
   <td colname="col2"> <p>傳回搜尋詞的下一行內容。 相關詞語以粗體顯示。 重複呼叫此標籤，以顯示目前結果的多個上下文行。 </p> <p>使用可選<span class="codeph"> length </span>屬性來限制顯示的字串長度，預設值為80個字元。 如果此標籤由<span class="codeph"> &lt;search-if-context&gt; </span>或<span class="codeph"> &lt;search-if-any-context&gt; </span>標籤集包含長度屬性，則忽略<span class="codeph">長度</span>屬性。 </p> <p><span class="codeph"> encoding </span>屬性是可選的，它可以使用HTML編碼（預設值）、Javascript編碼、Perl編碼或無來編碼輸出字元。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>11 </p> </td> 
   ...
   <td colname="col2"> <p>此進階標籤會顯示目前結果的中繼資料欄位（url、title、desc、keys、target、body、alt、date、charset，以及在<span class="uicontrol">選項</span> &gt; <span class="uicontrol">中繼資料</span> &gt;定義）中定義的語言或欄位，這些欄位在<span class="codeph">名稱</span>屬性中。 例如: </p> <p> <span class="codeph"> &lt;search-display-field name="title" length="70" none="no title"&gt; </span> </p> <p>輸出搜尋結果的頁面標題。 如果指定了可選的<span class="codeph">無</span>屬性，則僅當沒有與欄位關聯的內容時，其值才會顯示在結果頁上。 </p> <p><span class="codeph">日期格式</span>、<span class="codeph"> gmt </span>和<span class="codeph">語言</span>屬性只有在指定欄位的內容類型為<span class="codeph">日期</span>時才相關。 </p> <p><span class="codeph"> date-format </span>屬性採用UNIX樣式的日期格式字串，如<span class="codeph"> %A, %B %d, %Y </span>（2016年7月25日星期一）。 <span class="codeph"> gmt </span> 預設 <span class="codeph"> 為 </span> yes，並控制日期字串的時間部分是以GMT( <span class="codeph"> yes </span>)或帳戶的時區( <span class="codeph"> no </span>)輸出。 </p> <p>請參閱<a href="../c-appendices/c-templates.md#section_4BBDBBEF2B96414497617CD4B52D96E4" type="section" format="dita" scope="local">日期格式字串</a>。 </p> <p><span class="codeph"> language </span>屬性控制輸出日期字串的語言和地區設定慣例。 <span class="codeph"> 0  </span> （預設值）表示「使用帳戶語言」。<span class="codeph"> 2 </span> 意指「使用檔案語言」。<span class="codeph">語言</span>值<span class="codeph"> 1 </span>保留供將來使用)。 其他任何<span class="codeph">語言</span>值都會解譯為特定語言識別碼，例如，<span class="codeph"> en_US </span>表示"English(United States)"。 </p> <p>請參閱<a href="../c-appendices/c-templates.md#section_0490DECC00E34691ADE5A9ED90A6D911" type="section" format="dita" scope="local">語言標識符</a>。 </p> <p>可選的<span class="codeph"> length </span>屬性用於限制顯示的字串長度，預設值為80個字元。 </p> <p>可選的<span class="codeph">編碼</span>屬性控制輸出是否為HTML編碼、JavaScript編碼、Perl編碼、URL編碼或未編碼，以便在結果頁上輸出。 <span class="codeph">編碼</span>的預設值為<span class="codeph"> html </span>。 通常，您不需要指定編碼屬性。 </p> <p>可選的<span class="codeph">引號</span>屬性控制個別項目輸出是否用雙引號（如果<span class="codeph"> encoding=perl </span>，則為單引號）。 <span class="codeph">引號</span>的預設值為<span class="codeph"> no </span>。 </p> <p>選用的<span class="codeph">逗號</span>屬性可控制個別輸出項目是否以逗號分隔。 <span class="codeph">逗號</span>的預設值為<span class="codeph"> yes </span>。 對於非清單類型欄位，將忽略<span class="codeph">逗號</span>屬性。 </p> <p>可選的<span class="codeph">單位</span>屬性控制應用於鄰近搜索輸出欄位的距離單位。 <span class="codeph">單位</span>的預設值是根據與給定鄰近搜索輸出欄位相關聯的位置類型欄位的「預設單位」設定確定的。 </p> <p>請參閱<a href="../c-appendices/r-about-proximity-search.md#reference_45AC6BB50609431ABD31DA46EE65360D" type="reference" format="dita" scope="local">關於proximity search</a>。 </p> <p>可選的<span class="codeph">分隔符</span>屬性定義了在清單類型欄位的輸出值之間插入的單個字元或分隔符。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>12 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field-values name="field-name"&gt; ...&lt;search-display-field-values&gt; </span> </p> </td> 
   <td colname="col2"> <p>此標籤會建立循環，以列舉目前結果的中繼資料欄位值(url、title、desc、keys、target、body、alt、date、charset和語言或欄位，這些欄位定義在<span class="uicontrol">選項</span> &gt; <span class="uicontrol">中繼資料</span> &gt; <span class="uicontrol">定義</span>下。 請勿將此標籤巢狀內嵌在其他<span class="codeph"> &lt;search-display-field-values&gt; </span>標籤內。 <span class="codeph">名稱</span>屬性指定包含要枚舉的值的欄位的名稱。 此標籤對於已勾選「允許清單</span>」屬性的欄位最有用（在「<span class="uicontrol">選項</span> &gt; <span class="uicontrol">中繼資料</span> &gt; <span class="uicontrol">定義</span>」下）。<span class="uicontrol"> </span></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>13 </p> </td> 
   ...
   <td colname="col2"> <p>此標籤輸出當前<span class="codeph"> &lt;search-display-field-values&gt; </span>循環迭代的元資料欄位值(url、title、desc、keys、target、body、alt、date、charset和在<span class="uicontrol">選項</span> &gt; <span class="uicontrol">元資料</span> &gt; <span class="uicontrol">定義</span>下定義的語言或欄位。 此標籤僅在<span class="codeph"> &lt;search-display-field-values&gt; </span>循環內有效。 <span class="codeph">日期格式</span>、<span class="codeph"> gmt </span>和<span class="codeph">語言</span>屬性只有在<span class="codeph">&lt;search-display-field-values&gt;</span>標籤為<span class="codeph">日期</span>的欄位名稱的內容類型時才相關。 <span class="codeph"> date-format </span>屬性採用UNIX樣式的日期格式字串，如<span class="codeph"> "%A </span>, <span class="codeph"> %B </span> <span class="codeph"> %d </span>, <span class="codeph"> %Y </span>"（對於"Monday, July 25, 2016」）。 <span class="codeph"> gmt </span>屬性預設為<span class="codeph">是</span>，並控制日期字串的時間部分是以GMT輸出（<span class="codeph">是</span>）還是帳戶的時區（<span class="codeph">否</span>）。 </p> <p><span class="codeph"> language </span>屬性控制輸出日期字串的語言和地區設定慣例。 <span class="codeph"> 0  </span> （預設值）表示「使用帳戶語言」。其他任何<span class="codeph">語言</span>值都會解譯為特定語言識別碼，例如，<span class="codeph"> en_US </span>表示"English(United States)"。 </p> <p>可選的<span class="codeph">編碼</span>屬性控制輸出是否為HTML編碼、JavaScript編碼、Perl編碼、URL編碼或未編碼，以便在結果頁上輸出。 <span class="codeph">編碼</span>的預設值為<span class="codeph"> html </span>。 通常，您不需要指定編碼屬性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>14 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field-value-count name="field-name"&gt; </span> </p> </td> 
   <td colname="col2"> <p>輸出當前結果中以名稱屬性指定的元資料欄位(url、title、desc、keys、target、body、alt、date、charset和語言或欄位，這些欄位在「<span class="uicontrol">選項</span> &gt; <span class="uicontrol">元資料</span> &gt;定義</span>」下定義。 <span class="uicontrol">此標籤可顯示在結果循環中的任何位置。 </span></p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>15 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-display-field-value-counter&gt; </span> </p> </td> 
   <td colname="col2"> <p>輸出當前<span class="codeph"> &lt;search-display-field-values&gt; </span>循環迭代的序數計數器（1、2、3等）。 此標籤僅在<span class="codeph"> &lt;search-display-field-values&gt; </span>循環內有效。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>16 </p> </td> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>如果下次呼叫<span class="codeph"> &lt;search-title&gt; </span>會傳回（或不傳回）檔案標題的文字，這些標籤會包含它們之間的HTML。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果下次呼叫<span class="codeph"> &lt;search-context&gt; </span>傳回（或未傳回）非空白的上下文字串，這些標籤會包含它們之間的HTML。 length屬性會覆寫任何內含<span class="codeph"> &lt;search-context&gt; </span>標籤上的length屬性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
   ...
   <td colname="col2"> <p>如果有（或不有）與結果相關聯的上下文字串，這些標籤會包含它們之間的HTML。 length屬性會覆寫任何內含<span class="codeph"> &lt;search-context&gt; </span>標籤上的length屬性。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>6 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>這些進階標籤會根據「名稱」屬性中指定的欄位是否包含內容，在它們之間包含HTML。 如果指定了可選的"value"屬性，則標籤會根據給定值是否與當前結果中欄位的值匹配（或不匹配），在它們之間包含HTML。 這些標籤僅在結果循環內（在<span class="codeph"> &lt;search-results&gt; </span>和<span class="codeph"> &lt;/search-results&gt; </span>標籤之間）。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>這對標籤類似於<span class="codeph"> &lt;search-link&gt; ...&lt;/search-link&gt; </span>標籤。 按一下產生的錨點連結時，會顯示結果頁面，但頁面會捲動至結果前的最接近錨點標籤。 對於PDF連結，Acrobat檢視器會顯示包含結果的頁面。 選用的target屬性會指定可畫格瀏覽器應顯示結果頁面的指定視窗。 </p> <p>將hbx-enable屬性設為"yes"，以運用HBX提供的分析。 將hbx-linkid-name設為您要追蹤的中繼資料欄位名稱。 例如，若要依SKU編號追蹤搜尋結果，請將hbx-linkid-name設為包含SKU資訊的中繼資料欄位名稱。 </p> <p>目前不支援日期類型欄位。 hbx-linkid-name的值會附加至產生之錨點的連結ID。 每當命名的Meta-data欄位空白時，hbx-linkid-none屬性的值會附加至連結ID。 hbx-linkid-length的值會限制從Meta標籤擷取和顯示的字元數。 預設字元數為12。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>3 </p> </td> 
...
下列標籤有條件地包含它們之間的文字。 它們只能出現在「循環」標籤中：&lt;`search-results>`和`<search-field-values>`。 它們用於測試當前結果在結果集中的位置。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>如果目前的結果是（或不是）頁面上的第一個結果（在<span class="codeph"> &lt;search-results&gt; </span>內使用時）或第一個欄位值（在<span class="codeph"> &lt;search-field-values&gt; </span>內使用時），這些標籤會包含它們之間的文字。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p>如果目前的結果是（或不是）頁面上的最後一個結果（在<span class="codeph"> &lt;search-results&gt; </span>內使用時）或最後一個欄位值（在<span class="codeph"> &lt;search-field-values&gt; </span>內使用時），這些標籤會包含它們之間的文字。 此標籤可用於在結果之間插入分隔符。 例如，這會在結果之間插入<span class="codeph"> &lt;hr&gt; </span>標籤： </p> <p> <code class="syntax html"> &lt;search-results&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果目前的結果不是頁面上的第一個或最後一個結果（在<span class="codeph"> &lt;search-results&gt; </span>內使用時），或不是第一個或最後一個欄位值（在<span class="codeph"> &lt;search-field-values&gt; </span>內使用時），這些標籤會包含它們之間的文字。 標籤的not版本會測試結果是第一個還是最後一個。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   ...
   <td colname="col2"> <p>如果目前的結果是（或不是）頁面上的替代結果（在<span class="codeph"> &lt;search-results&gt; </span>內使用時）或替代欄位值（在<span class="codeph"> &lt;search-field-values&gt; </span>內使用時），這些標籤會包含它們之間的文字。 「替代」結果為頁面上的第二、第四、第六等。 此示例將不同的類應用於替代表行。 請注意，使用<span class="codeph"> &lt;search-lt&gt; </span>和<span class="codeph"> &lt;search-gt&gt; </span>來允許<span class="codeph"> &lt;search-if-alt&gt; </span>標籤置於<span class="codeph"> &lt;tr&gt; </span>標籤中。 </p> <p> <code class="syntax html"> &nbsp;&nbsp;&nbsp;&nbsp;&lt;search-results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;search-lt&gt;tr&lt;search-if-alt&gt;&nbsp;class="alt"&lt;/search-if-alt&gt;&lt;search-gt&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&gt;&lt;search-url&gt;&lt;/td&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/tr&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&lt;/search-results&gt; </code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果目前的結果是（或不是）偶數編號的結果（當使用在<span class="codeph"> &lt;search-results&gt; </span>中時）或偶數編號的欄位值（當使用在<span class="codeph"> &lt;search-field-values&gt; </span>中時），這些標籤會包含它們之間的文字。 如果搜索結果的<span class="codeph"> &lt;search-index&gt; </span>值是偶數，則搜索結果是偶數。 換句話說，如果它在整個結果集中的位置是均勻的。 這可能與<span class="codeph"> &lt;search-if-alt&gt; </span>不同，後者會測試結果在頁面上的位置，而不是在整個結果集內。 以下兩個表格說明了差異： </p> </td> 
  </tr> 
 </tbody> 
</table>
...
最後，請注意`<search-if-even>`對於搜索欄位值始終與`<search-if-alt>`相同，因為不分頁欄位值。

## 欄位值清單標籤{#section_D3298B5F976447DBA0032B883DCC91B1}

下列進階標籤會輸出欄位值，以及整組搜尋結果的相關資料。 這些標籤僅針對搜索查詢中的`sp-sfvl-field` CGI參數所指定的欄位產生輸出。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果具有指定屬性的<span class="codeph"> &lt;search-field-value-list-count name="field-name" value="field-value"&gt; </span>等同呼叫傳回大於零的值，這些標籤會顯示它們之間的HTML。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   ...
   <td colname="col2"> <p>如果具有指定屬性的<span class="codeph"> &lt;search-field-value-list-count name="field-name" value="field-value"&gt; </span>等等效呼叫傳回單一值，這些標籤會顯示它們之間的內容。 這通常用於帳戶使用刻面槽時。 有了Facet槽，您通常只想在關聯的名稱槽包含單一項目時顯示值槽。 在傳輸範本中執行此檢查比在表現層中執行檢查更有效。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
下列進階標籤會使用循環結構，從整個搜尋結果集列舉和輸出欄位值及相關資料。 這些標籤僅針對搜索查詢中的`sp-sfvl-field` CGI參數所指定的欄位產生輸出。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>此標籤會輸出目前&lt;search-field-values&gt;循環小版本的欄位值。 此標籤僅在<span class="codeph"> &lt;search-field-values&gt; </span>循環內有效。 只有在&lt;search-field-values&gt;標籤中指定欄位名稱的內容類型為"date"時，「date-format」、「gmt」和「language」屬性才相關。 「date-format」屬性採用UNIX樣式的日期格式字串，如「%A, %B %d, %Y」（對於「2020年7月25日星期一」）。 </p> <p>請參閱<a href="../c-appendices/c-templates.md#section_4BBDBBEF2B96414497617CD4B52D96E4" type="section" format="dita" scope="local">日期格式字串</a>。 </p> <p>可選的「encoding」屬性控制輸出字串字元是否為HTML編碼、JavaScript編碼、Perl編碼、URL編碼或未編碼，以便在結果頁面上輸出。 「encoding」的預設值為「none」。 通常，您不需要指定編碼屬性。 "gmt"預設為"yes"，並控制日期字串的時間部分應以GMT("yes")或帳戶的時區("no")輸出。 「語言」屬性控制輸出日期字串的語言和地區設定慣例。 "0"（預設值）表示「使用帳戶語言」。 任何其他「語言」值都會解讀為特定語言識別碼，例如，「en_US」意指「英文（美國）」。 </p> <p>請參閱<a href="../c-appendices/c-templates.md#section_0490DECC00E34691ADE5A9ED90A6D911" type="section" format="dita" scope="local">語言標識符</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>1 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-field-value-count results="yes/no"&gt; </span> </p> </td> 
   <td colname="col2"> <p>此標籤輸出與當前<span class="codeph"> &lt;search-field-values&gt; </span>循環小版本關聯的計數。 輸出計數是包含欄位值的整個結果集中的結果數(results="yes")，或整個結果集中欄位值的總計。 「results」的預設值為「no」。 </p> <p>對於非清單類型欄位，results="yes"和results="no"是相等的。 此標籤僅在<span class="codeph"> &lt;search-field-values&gt; </span>循環內有效。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>4 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-field-value-counter&gt; </span> </p> </td> 
   <td colname="col2"> <p>此標籤輸出當前<span class="codeph"> &lt;search-field-values&gt; </span>循環迭代的序數計數器。 此標籤僅在<span class="codeph"> &lt;search-field-values&gt; </span>循環內有效。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
Sempless提供方便使用的「您是指？」 服務，以建議替代搜尋詞。 例如，如果使用者拼錯搜尋詞，建議可協助使用者建議正確的拼字來尋找結果。 系統也可以建議相關關鍵字，協助使用者發現結果。 產生建議時，建議服務會使用兩本字典：一種是根據帳戶語言（在&#x200B;**[!UICONTROL Indexing]** > **[!UICONTROL Words and Languages]** > **[!UICONTROL Language]**&#x200B;下設定），另一種是根據帳戶索引中的關鍵字唯一建立。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>使用任何「建議」範本標籤來包住這些標籤，例如<span class="codeph"> &lt;search-seccuption&gt; </span>、<span class="codeph"> &lt;search-suckement-link&gt; </span>等。 如果搜尋產生建議，搜尋引擎會輸出並處理開啟與關閉標籤之間的一切。 如果搜尋未產生建議，則不會輸出任何巢狀內容。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>此標籤會列出目前建議的查詢詞語（例如，「打算」原本輸入為「意向」的查詢）。 標籤沒有屬性，只能顯示在<span class="codeph"> &lt;search-explications&gt; </span>循環中。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>5 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>這些條件標籤會根據建議回圈中建議的詞語是否是第一個詞語，在它們之間包含HTML。 標籤必須出現在開啟和關閉<span class="codeph"> &lt;search-seccuption&gt; </span>標籤之間。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-if&gt; ...  &lt;/search-if&gt; </span> </p> </td> 
   <td colname="col2"> <p>這些條件標籤會根據建議回圈中建議的詞語是否為最後一個詞語，在它們之間包含HTML。 標籤必須出現在開啟和關閉<span class="codeph"> &lt;search-seccuption&gt; </span>標籤之間。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>8 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-suggestion-index&gt; </span> </p> </td> 
   <td colname="col2"> <p>此標籤會傳回目前建議搜尋詞的數值索引。 標籤必須出現在open和close <span class="codeph"> &lt;search-seccuption&gt; </span>標籤之間。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>9 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-suggestion-total&gt; </span> </p> </td> 
   <td colname="col2"> <p>此標籤會傳回產生的建議搜尋詞總數。 標籤必須出現在open和close <span class="codeph"> &lt;search-seccuption&gt; </span>標籤之間。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>10 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-suggestion-result-count&gt; </span> </p> </td> 
   <td colname="col2"> <p>此標籤會傳回建議搜尋詞的結果總數。 標籤必須出現在open和close <span class="codeph"> &lt;search-seccuption&gt; </span>標籤之間。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>插入指定查詢字串的表單輸入標籤。 進階的可選「query-number」屬性會控制表單輸入標籤使用的編號查詢。 例如，<span class="codeph"> &lt;search-input-query query-number=1&gt; </span>輸出<span class="codeph"> sp_q_1 </span>查詢的表單輸入標籤。 如果未指定"query-number"，或如果"query-number"是"0"，則插入主<span class="codeph"> sp_q </span>查詢的輸入標籤。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>18 </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>在結果頁面上的其他HTML或範本標籤內插入其中一個「搜尋」範本標籤的輸出。 <span class="codeph"> &lt;search-lt&gt; </span> 插入小於字元。使用<span class="codeph"> &lt;search-lt&gt; </span>和<span class="codeph"> &lt;search-gt&gt; </span>提供了逸出標籤定義的方法，以便您可以使用「搜尋」模板標籤作為屬性值。 當回應搜尋而轉譯範本時，小於號(&lt;)會取代<span class="codeph"> &lt;search-lt&gt; </span>標籤。 例如，<span class="codeph"> &lt;search-link&gt; </span>等效於<span class="codeph"> &lt;search-lt&gt;a href="&lt;search-url&gt;"&lt;search-gt&gt; </span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>20 </p> </td> 
   <td colname="col1"> <p> <span class="codeph"> &lt;search-gt&gt; </span> </p> </td> 
   <td colname="col2"> <p>在結果頁面上的其他HTML或範本標籤內插入其中一個「搜尋」範本標籤的輸出。 <span class="codeph"> &lt;search-gt&gt; </span> 插入大於字元。使用<span class="codeph"> &lt;search-lt&gt; </span>和<span class="codeph"> &lt;search-gt&gt; </span>提供了逸出標籤定義的方法，以便您可以使用其他模板標籤作為屬性值。 當回應搜尋而轉譯範本時，大於號(&gt;)會取代<span class="codeph"> &lt;search-gt&gt; </span>標籤。 例如，<span class="codeph"> &lt;search-link&gt; </span>等效於<span class="codeph"> &lt;search-lt&gt;a href="&lt;search-url&gt;"&lt;search-gt&gt; </span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>21 </p> </td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>如果為搜索查詢指定了<span class="codeph"> sp_advanced=1 </span> CGI參數，則這些標籤包括HTML。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>7 </p> </td> 
   ...
   <td colname="col2"> <p>如果給定參數無效，則這些標籤包括或排除它們之間的HTML。 </p> <p>目前僅支援<span class="codeph"> sp_q_location[_#] </span>參數。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>8 </p> </td> 
...
可讓您控制搜尋範本上`<form>`內核取方塊、選項按鈕和清單方塊的預設選取狀態的標籤。
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>用於範本中，取代<span class="codeph"> &lt;input&gt; </span>標籤。 當標籤寫入瀏覽器時，輸入<span class="codeph">的字詞</span>會取代<span class="codeph"> search-input </span>，而標籤中的所有其他資訊會依原樣輸出。 此外，如果標籤中指定的<span class="codeph">名稱</span>列為CGI參數，而標籤中指定的<span class="codeph">值</span>是該CGI參數的值，則標籤結尾處將添加選中的<span class="codeph">單詞</span>。 這樣，您就可以自動將搜索結果中的預設單選按鈕或複選框狀態與當前查詢相同。 </p> <p>例如，核取方塊的HTML程式碼可能如下所示： </p> <p> <span class="codeph"> &lt;input type="checkbox" name="sp_w" value="exact"&gt;無相似音效  </span> </p> <p>該核取方塊的對應範本代碼如下： </p> <p> <span class="codeph"> &lt;search-input type="checkbox" name="sp_w" value="exact"&gt;無相似音效  </span> </p> <p>如果查詢的CGI參數字串包含<span class="codeph"> sp_w=exact </span>，則寫入瀏覽器且搜尋結果顯示的標籤如下（檢查<span class="codeph">的</span>字詞會插入標籤結尾）: </p> <p> <span class="codeph"> &lt;input type="checkbox" name="sp_w" value="exact" checked=""&gt;無相似音效  </span> </p> <p>如果查詢的CGI參數字串不包含<span class="codeph"> sp_w=exact </span>，則寫入瀏覽器且搜尋結果顯示的標籤如下（標籤中未列出勾選</span>的字詞<span class="codeph">）: </span></p> <p> <span class="codeph"> &lt;input type="checkbox" name="sp_w" value="exact"&gt;無相似音效  </span> </p> <p><span class="codeph"> &lt;search-input&gt; </span>標籤對於將複選框和單選按鈕放入搜索模板非常有用。 如果您有要添加到搜索模板中<span class="codeph"> &lt;form&gt; </span>的複選框或單選按鈕，請使用<span class="codeph"> &lt;search-input...&gt; </span>代替<span class="codeph"> &lt;input...&gt; </span>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col01"> <p>2 </p> </td> 
   ...
   <td colname="col2"> <p><span class="codeph"> &lt;form&gt; </span>標籤中的下拉清單框以<span class="codeph"> &lt;select&gt; </span>標籤啟動，並以<span class="codeph"> &lt;/select&gt; </span>標籤結束。 關聯的CGI參數的<span class="codeph">名稱</span>列在<span class="codeph"> &lt;select&gt; </span>標籤內。 <span class="codeph"> &lt;select&gt; </span>標籤後面是<span class="codeph"> &lt;option&gt; </span>標籤的清單，這些標籤指定要在清單框中顯示的值。 </p> <p><span class="codeph"> &lt;search-select&gt; </span>、<span class="codeph"> &lt;/search-select&gt; </span>、<span class="codeph"> &lt;search-option&gt; </span>和<span class="codeph"> &lt;/search-option&gt; </span>標籤提供與<span class="codeph"> &lt;search-input&gt; </span>標籤類似的功能。 即，如果<span class="codeph"> &lt;search-select&gt; </span>標籤中的<span class="codeph">名稱</span>列為CGI參數，且該CGI的<span class="codeph">值</span>值&lt;a9/&gt;被列為CGI參數，則在傳送至瀏覽器的<span class="codeph"> &lt;option&gt; </span>標籤的末尾自動添加選定的<span class="codeph">參數會列為特定<span class="codeph"> &lt;search-option&gt; </span>標籤中的<span class="codeph">值</span>。 </span>這樣，您就可以自動讓搜尋結果中的預設清單方塊選擇與目前查詢相同。 </p> <p>例如，典型清單框如下所示： </p> <p> <code class="syntax html"> &lt;select&nbsp;name="sp_x"&nbsp;size=1&gt; 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 相符項目：完整工作日名稱的國家代表，例如「星期一」。 <span class="uicontrol">語言學</span> &gt; <span class="uicontrol">字詞與語言</span> &gt; <span class="uicontrol">語言</span>中的設定確定國家代表。 </p> <p>請參閱<a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local">關於字詞和語言</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%a </p> </td> 
   <td colname="col2"> <p> 相符項目：縮寫工作日名稱的國家代表，其中縮寫是前三個字元，例如"Mon"。 <span class="uicontrol">語言學</span> &gt; <span class="uicontrol">字詞與語言</span> &gt; <span class="uicontrol">語言</span>中的設定確定國家代表。 </p> <p>請參閱<a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local">關於字詞和語言</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%B </p> </td> 
   <td colname="col2"> <p> 符合完整月份名稱的國家代表，例如"June"。 <span class="uicontrol">語言學</span> &gt; <span class="uicontrol">字詞與語言</span> &gt; <span class="uicontrol">語言</span>中的設定確定國家代表。 </p> <p>請參閱<a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local">關於字詞和語言</a>。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>%b </p> </td> 
   <td colname="col2"> <p> 相符項目：縮寫月份名稱的國家代表，其中縮寫是前三個字元，例如"Jun"。 <span class="uicontrol">語言學</span> &gt; <span class="uicontrol">字詞與語言</span> &gt; <span class="uicontrol">語言</span>中的設定確定國家代表。 </p> <p>請參閱<a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local">關於字詞和語言</a>。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 符合"ante meridiem"或"post meridiem"（例如"PM"）的國家代表。 <span class="uicontrol">語言學</span> &gt; <span class="uicontrol">字詞與語言</span> &gt; <span class="uicontrol">語言</span>中的設定確定國家代表。 </p> <p>請參閱<a href="../c-about-linguistics-menu/c-about-words-and-language.md#concept_CEB4B9576F3C4E2EB87B352EEC738D79" type="concept" format="dita" scope="local">關於字詞和語言</a>。 </p> </td> 
  </tr> 
  <tr> 
...
## 語言標識符{#section_0490DECC00E34691ADE5A9ED90A6D911}

下表包含每個支援語言的語言識別碼。 您可以在下列範本標籤中，將這些識別碼當做選用「語言」屬性的值：

* `search-date` 和 `search-display-field`.

   請參閱[結果循環字串tags](../c-appendices/c-templates.md#section_80D68334E8D04A33937A6E58ABAAA320)。
...
## 指定content-type HTTP header {#section_AEED823E9938448A9EDB2F286D9CFD90}

您可以使用下列標籤來指定「內容類型」HTTP回應標題：

`<search-content-type-header [content="MIME-type"] [charset="charset-name"]>`

`content`和`charset`屬性是可選的。 此標籤應盡早出現在範本中。 也建議它出現在`<search-html-meta-charset>`或`<search-xml-decl>`之前，因為它會影響這些標籤的行為。

如果您未指定`content`屬性，則`MIME-type`的值預設為在&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL Crawling]** > **[!UICONTROL Content Types]**&#x200B;中設定的值。 如果指定`content`屬性，則它將用作`<search-html-meta-charset>`標籤的預設`content`屬性。

如果未指定`charset`屬性，則不會將`charset`值寫入`content-type`標題。

如果指定`charset="1"`，則`charset-name`的實際值是`sp_f` CGI參數的值。 如果搜索中未提交`sp_f` CGI參數，則會從您的帳戶設定中讀取`charset-name`的實際值。 您可以在&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**&#x200B;下查看或更改與帳戶關聯的字元集。

請參閱[設定您的個人使用者資訊](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6)。

您可以將特定字元集名稱列為`charset`值，例如`charset="iso-8859-1"`或`charset="Shift-JIS"`，以選擇該名稱。

如果指定`charset`屬性，則它將用作`<search-html-meta-charset>`和`<search-xml-decl>`標籤的預設`charset`屬性，並輸出至`content-type`標題。

## 在HTML範本{#section_E0D1816ABB5846BEBE9C26D5980CCBE6}中指定字元集

預設的HTML搜尋結果範本會透過下列標籤指定與目前帳戶關聯的字元集：

`<search-html-meta-charset [content="MIME-type"] [charset="charset-name"]>`

內容和字元集屬性是選用的。 此標籤必須出現在範本的HTML `<head>`區段中。 此標籤會在範本產生的HTML頁面上產生下列標籤：

`<meta http-equiv="content-type" content="MIME-type; charset=charset-name">`

如果您未指定內容屬性，則`MIME-type`的實際值預設為兩個值之一。 如果`<search-content-type-header>`標籤指定了`content`屬性，則使用該值。 否則，所用的值是&#x200B;**[!UICONTROL Templates]** > **[!UICONTROL Settings]** > **[!UICONTROL Content Type]**&#x200B;標籤中的值集。

如果您未指定`charset`屬性，則`charset-name`的實際值預設為兩個值之一。 如果`<search-content-type-header>`標籤指定了`charset`屬性，則使用該值。 否則，會從您的帳戶設定中讀取`charset-name`的實際值。 您可以在&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**&#x200B;下查看或更改與帳戶關聯的字元集。

請參閱[設定您的個人使用者資訊](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6)。

如果指定`charset="1"`，則`charset-name`的實際值是`sp_f` CGI參數的值。 如果搜索中未提交`sp_f` CGI參數，則`charset-name`的實際值是在`<search-content-type-header>`標籤中設定的值（如果已指定），或是在帳戶設定中設定的值。

您可以指定特定的字元集名稱，如`charset="charset-name"`中。 例如，`charset="iso-8859-1"`或`charset="Shift-JIS"`。

`<search-html-meta-charset>`標籤是可選的。 如果您移除它，瀏覽器會假設`content-type`的預設值，如下所示：`content="text/html; charset=ISO-8859-1"`。 您也可以選擇將`<search-html-meta-charset>`標籤取代為您自己的`http-equiv`標籤。

## 在XML模板{#section_17DC31CDCC104F5F8081466B41A96E9D}中指定字元集

預設的XML搜索結果模板通過以下標籤指定與當前帳戶關聯的字元集：

`<search-xml-decl [charset="charset-name"]>`

`charset`屬性是可選的。 此標籤必須出現在範本頂端，但必須出現在任何`<search-content-type-header>`標籤之後。 此標籤會在XML檔案上產生下列標籤，這些標籤是從範本產生的：

`<?xml version="1.0" encoding="charset-name" standalone="yes" ?>`

如果您未指定`charset`，則`charset-name`的實際值預設為兩個值之一。 如果`<search-content-type-header>`指定了`charset`屬性，則使用該值。 否則，會從您的帳戶設定中讀取`charset-name`的實際值。 您可以在&#x200B;**[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL Personal Information]** > **[!UICONTROL Character Encoding]**&#x200B;下查看或更改與帳戶關聯的字元集。

請參閱[設定您的個人使用者資訊](../c-about-settings-menu/c-about-my-profile-menu.md#task_A11A3BE2527B4204B896E04303B04AA6)。

如果指定`charset="1"`，則`charset-name`的實際值是`sp_f` CGI參數的值。 如果搜索中未提交`sp_f` CGI參數，則`charset-name`的實際值是在`<search-content-type-header>`標籤中設定的值（如果已指定）或在帳戶設定中設定的值。

如果需要，可以指定特定的字元集名稱，如`charset="charset-name"`。 例如, `charset="iso-8859-1" or charset="Shift-JIS"`。

您可以選擇將`<search-xml-decl>`標籤取代為您自己的`?xml`標籤。

## 在另一個{#section_7D1FCD3D9E2340C291E354C9720E8BC0}中包括搜索模板

要將一個搜索模板包含在另一個中，請使用`<search-include>`標籤，將檔案屬性設定為要包括的模板檔案的名稱，如下例所示：

`<search-include file="seo/seo_search_title.tpl" />`

SEO搜索模板段位於`seo/`子資料夾中，普通搜索模板位於`templates/`子資料夾中。 只有。tpl檔案有意義加入此內容。
...
要設定搜索表單以使用特定傳輸模板（預設值除外），請使用`sp_t`查詢參數。 例如，假設您有一個搜尋範本，稱為「清除」，用於您網站的已標籤銷售區。 您使用標準HTML搜尋表單，並加入下列其他表單程式碼：
