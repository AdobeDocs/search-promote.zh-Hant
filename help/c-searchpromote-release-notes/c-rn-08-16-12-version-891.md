...
* 已將選 [!DNL SSO-Login-Only] 項新增至 [!DNL Support] 的標籤中 [!DNL Member Center]。

* 修正會使搜尋編目擱置的指令碼篩選。
* 修正當您按一下滑鼠右鍵，然後按一下時，將不會發 [!DNL Banner]生任何情況的錯誤 [!DNL Select Different Banner from visual rule builder]。
